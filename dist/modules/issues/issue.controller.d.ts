...
export declare const createIssue: (req: Request, res: Response, next: import("express").NextFunction) => void;
export declare const getAllIssues: (req: Request, res: Response, next: import("express").NextFunction) => void;
